...
# Import Data
data <- read_csv("/Users/Wolfe/Desktop/Winter 2018/Machine Learning/r_ensemble.csv")
```

<h1 id="title">Ensemble Exploration<h1>
...
<p id="desc">The following is a visual report of an ensemble of many machine learning algorithms, with different combinations of cross validations, dataset size, data types, and individual algorithm parameters.</p>
